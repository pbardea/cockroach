...
func (b *changefeedResumer) Resume(ctx context.Context, execCtx interface{}) error {
	...
	logRetryableError := func(err error) {
	...
	return utilccl.RetryDistSQLFlowCustomRetryable(ctx, isRetryableError, runChangefeed, logRetryableError)
}
