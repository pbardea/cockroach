...
// injectStats injects statistics into a table and ensures that the BACKUP will
// see these stats.
func injectStats(t *testing.T, sqlDB *sqlutils.SQLRunner, tableName string, columnName string) [][]string {
	return injectStatsWithRowCount(t, sqlDB, tableName, columnName, 100 /* rowCount */)
}

// injectStatsWithValues injects statistics into a table and ensures that the
// BACKUP will see these stats.
func injectStatsWithRowCount(t *testing.T, sqlDB *sqlutils.SQLRunner, tableName string, columnName string, rowCount int) [][]string {
